...
client.on('ready', () => {
    client.user.setPresence({ activity: { name: "-yardım" }, status: 'dnd' })
    client.channels.cache.get('806223374270332928').join() // ses kanalı İD
...
.addField("Sunucudaki Kişi Sayısı:", guild.memberCount)
   ...
   client.channels.cache.get('807525571026223154').send(plasmic);
...
.addField("Sunucudaki Kişi Sayısı:", guild.memberCount)
   ...
   client.channels.cache.get('807525477464014849').send(plasmicc);
